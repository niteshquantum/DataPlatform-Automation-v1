...
echo
echo "====================================="
echo "MSSQL LIQUIBASE XML CLEANUP"
echo "====================================="
echo
...
if [ ! -d "$LIQUIBASE_DIR" ]
then
    echo "ERROR: MSSQL Liquibase directory not found:"
    echo "$LIQUIBASE_DIR"
    exit 1
fi
...
then
    ...
    echo "====================================="
    echo "MSSQL LIQUIBASE XML PRESERVED"
    echo "====================================="
    echo
...
echo "Finding generated MSSQL Liquibase XML files..."
echo
...
echo "Validating MSSQL Liquibase XML cleanup..."
echo
...
then
    ...
    echo "ERROR: MSSQL master.xml not found after reset."
    exit 1

fi

echo "Generated MSSQL Liquibase XML files removed successfully."
echo "master.xml reset successfully."

echo
echo "====================================="
echo "MSSQL LIQUIBASE XML CLEANUP SUCCESSFUL"
echo "====================================="
echo
