...
TERRAFORM_DIR="$PROJECT_ROOT/terraform/mongodb"
...
LINUX_RESOURCES=(
    "null_resource.start_mongodb_linux"
...
then
    ...
    echo "====================================="
    echo "MONGODB TERRAFORM STATE RESET SUCCESSFUL"
    echo "====================================="
    echo
...
then
    ...
    echo "No MongoDB Linux resources found in Terraform state."
    echo "Nothing to reset."
    echo
...
echo "MongoDB Linux Terraform resources cleanup validated successfully."
