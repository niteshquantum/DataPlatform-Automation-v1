...
echo
echo "====================================="
echo "MYSQL LIQUIBASE XML CLEANUP"
echo "====================================="
echo
...
if [ ! -d "$LIQUIBASE_DIR" ]
then
    echo "ERROR: MySQL Liquibase directory not found:"
    echo "$LIQUIBASE_DIR"
    exit 1
fi
...
then
    ...
    echo "====================================="
    echo "MYSQL LIQUIBASE XML PRESERVED"
    echo "====================================="
    echo
...
# =====================================
# VALIDATE GENERATED XML CLEANUP
# =====================================

echo "Validating MySQL Liquibase XML cleanup..."
echo

REMAINING_XML_FILES="$(find "$LIQUIBASE_DIR" \
    -maxdepth 1 \
    -type f \
    -name "*.xml" \
    ! -name "master.xml" \
...
if [ ! -f "$MASTER_XML" ]
then
    echo "ERROR: master.xml not found after reset."
    exit 1
fi
...
echo
echo "====================================="
echo "MYSQL LIQUIBASE XML CLEANUP SUCCESSFUL"
echo "====================================="
echo
