...
$liquibaseDir = "$ROOT\liquibase\mysql"
...
Write-Host ""
Write-Host "====================================="
Write-Host "MYSQL LIQUIBASE XML CLEANUP"
Write-Host "====================================="
Write-Host ""
...
if (!(Test-Path $liquibaseDir)) {
    throw "MySQL Liquibase directory not found: $liquibaseDir"
}

if ($cleanupMode -eq "PRESERVE_DATA") {

    Write-Host "MySQL data is being preserved."
    Write-Host "Generated Liquibase XML files will also be preserved."
    Write-Host ""

    Write-Host "====================================="
    Write-Host "MYSQL LIQUIBASE XML PRESERVED"
    Write-Host "====================================="
    Write-Host ""
...
Write-Host "Validating Liquibase XML cleanup..."
Write-Host ""
...
if ($remainingXmlFiles.Count -gt 0) {
    throw "Generated MySQL Liquibase XML files still exist"
}
...
Write-Host ""
Write-Host "====================================="
Write-Host "MYSQL LIQUIBASE XML CLEANUP SUCCESSFUL"
Write-Host "====================================="
Write-Host ""
