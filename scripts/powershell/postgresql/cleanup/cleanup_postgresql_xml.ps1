...
$liquibaseDir = "$ROOT\liquibase\postgresql"
...
Write-Host ""
Write-Host "====================================="
Write-Host "POSTGRESQL LIQUIBASE XML CLEANUP"
Write-Host "====================================="
Write-Host ""
...
if (!(Test-Path $liquibaseDir)) {
    throw "PostgreSQL Liquibase directory not found: $liquibaseDir"
}
...
if ($cleanupMode -eq "PRESERVE_DATA") {
    ...
    Write-Host "====================================="
    Write-Host "POSTGRESQL LIQUIBASE XML PRESERVED"
    Write-Host "====================================="
    Write-Host ""
...
Write-Host "Validating PostgreSQL Liquibase XML cleanup..."
Write-Host ""
...
if ($remainingXmlFiles.Count -gt 0) {
    throw "Generated PostgreSQL Liquibase XML files still exist"
}
...
Write-Host ""
Write-Host "====================================="
Write-Host "POSTGRESQL LIQUIBASE XML CLEANUP SUCCESSFUL"
Write-Host "====================================="
Write-Host ""
