...
python "%PROJECT_ROOT%\scripts\discovery\discovery_engine.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\discovery\growth_analyzer.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\discovery\requirement_analyzer.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\assessment\assessment_engine.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\recommendation\recommendation_engine.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\governance\action_plan_engine.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\reporting\migration\technical_report.py" --database mssql
...
python "%PROJECT_ROOT%\scripts\reporting\migration\executive_report.py" --database mssql
